...
window.CHARYBDIS_FINAL_LAYOUT = {
  ...
  "keys": [
    ...
    },
    {
      ...
      "modifiers": [],
      "label": "Nav",
      "rationale": "evolved: Dynamic layer access: @access:L0->L1:hold:Nav",
    ...
    },
    {
      ...
      "rationale": "evolved: Raw Dash and Underscore key from canonical layer layout.",
      "optimizer_changed": true,
      "apply_batch": true
    },
    {
    ...
    },
    {
      ...
      "rationale": "evolved: Raw Grave Accent and Tilde key from canonical layer layout.",
      "optimizer_changed": true,
      "apply_batch": true
    },
    {
      ...
      "modifiers": [],
      "label": "Right Brace",
      "rationale": "evolved: Raw Right Brace key from canonical layer layout.",
      "optimizer_changed": true,
      "apply_batch": true
    },
    {
    ...
    },
    {
      ...
      "modifiers": [],
      "label": "Home",
      "rationale": "evolved: Raw Home key from canonical layer layout.",
      "optimizer_changed": true,
      "apply_batch": true
    },
    {
      ...
      "modifiers": [],
      "label": "End",
      "rationale": "evolved: Raw End key from canonical layer layout.",
      "optimizer_changed": true,
      "apply_batch": true
    },
    {
